...
mod test {
    ...
    fn test_base58_encoder() {
        assert_eq!(
            ...
            String::from("5usUX2PKUw7rbN238ggjxdD5HthFFFaJJpMLGBuo95KW6q5eNVpynaqX1PVFX2DAtPzrq\
            DLstm8JicBS16mbMPC")
        );
        assert_eq!(
    ...
    fn test_base58_decoder() {
        assert_eq!(
            base58_to_bytes(
                &String::from("61mNuLymU8nGjeLSgDsXAwT6WPwjPxfx1jK6469GdhHeU8ws1Ds6CrLGFJD\
